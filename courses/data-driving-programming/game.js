// Допишите функцию iter, которая является частью ядра игрового движка 
// и описывает в себе логику одного хода

// Алгоритм

//     Если здоровье игрока, которого атаковали на предыдущем шаге 
//     (в примерах этого и следующего пунктов мы предполагаем, 
//         что это первый игрок с именем name1), 
//         меньше или равно 0, то добавляем в лог элемент с сообщением 
//         вида ${name1} был убит и возвращаем лог. 
//         Игра закончена.

//     В ином случае, берём рандомную карту, вычисляем урон, 
//     записываем новое здоровье, формируем сообщение формата:
