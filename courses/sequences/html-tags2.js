...
// Первый — функция-трансформер, 
// второй — коллекция (в нашем случае список html-тегов).
...
// Реализуйте и экспортируйте функцию mirror, 
// которая переворачивает содержимое тегов, 
...
// Функцию b2p можно использовать для наглядного 
// сопоставления частного варианта операции отображения 
// с обобщённой реализацией операции отображения (собственно, map).

// Подсказки

//     Функция reverseStr (псевдоним функции reverse из модуля 
//     по работе со строками strings) делает переворот строки.
//     При необходимости вы можете самостоятельно импортировать 
//     функцию toString из библиотеки @hexlet/pairs-data 
...
//     Для разрешения противоречий в случае импорта 
//     нескольких функций с одинаковыми именами используйте псевдонимы (aliases)
