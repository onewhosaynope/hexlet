...
// Коробка состоит из двух отсеков, в одном из которых письмо, 
// а в другом лежит еще одна коробка, 
// в которой также два отсека и точно также один отсек с письмом, 
// а в другом - коробка. 
// Коробки могут быть вложены друг в друга сколько угодно раз. 
// Вам нужно добраться до коробки, 
// внутри которой нет вложенной коробки ни в одном из двух отсеков, 
// и отдать ее курьеру.
// Подчеркну, что во всех коробках, кроме той последней, 
// в одном отсеке письмо (любые данные, которые не являются парой), 
// а в другом - всегда коробка, но никогда не две коробки одновременно. 
// Сами отсеки при этом могут меняться, 
// то есть в одной коробке отсеком с письмом может быть первый, 
// а в другой - последний.
// Реализуйте рекурсивную функцию findPrimitiveBox, 
// которая принимает на вход "коробку" (пару), 
